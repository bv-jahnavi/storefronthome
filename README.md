...
- Preview: https://main--storefronthome--bv-jahnavi.hlx.page/
- Live: https://main--storefronthome--bv-jahnavi.hlx.live/
...
1. Open the `storefronthome` directory in your favorite IDE and start coding :)
